        ...
        with gr.Row():
            with gr.Column(scale=3):  # Input elements column (wider)
                ...
                with gr.Column():
                     ...
                     gr.Examples(
                        examples=[
                            ["examples/vid1.mp4", "Number", 20, None, "ElevenLabs", "David Attenboro (DBZ3Yn0vZCfYBbj7kyCY)", "eleven_multilingual_v2", None, "Claude", 1.0, "make it funny", False, 3, 0.02],
                            ["examples/vid2.mp4", "Threshold", 20, None, "Google Cloud TTS", None, None, "en-US-Studio-O (en-US)", "gpt", 1.0, "you are a FOULED MOUTH gangsta rapper using NONSTOP profanity , mocking Freddy Mercury saying his a gay ass bitch and swears like a motherfucker hates every move he does NONSTOP SWEARING FOUL MOUTH, ROAST !!! ROAST NON STOP WITH NO MERCIES ONLY EVIL PROFANE HARD LANGUAGE", True, 3, 0.02],
                            ["examples/vid3.mp4", "Number", 10, None, "ElevenLabs", "David Attenboro (DBZ3Yn0vZCfYBbj7kyCY)", "eleven_multilingual_v2", None, "gpt", 1.0, "you are a gangsta rapper using profanity , narrate this gameplay, spectating the players playing lethal company, insult each one that is present in the spectate, ALWAYS MENTION the spectated character's name the name of the player that is spectated is written in red on top of the screen). pay attention to text changes in the frames if happening. and the dea list", False, 3, 0.02]
                        ],
                         inputs=[
                                video_input,
